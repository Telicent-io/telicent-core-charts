...
| Name                                | Description                                                                                                                                                                                        | Value                                                   |
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| `client.id`                         | Unique client identifier. Used for offset tracking, gRPC request identification, and server-side logging. Must be unique when multiple clients share a storage backend. Example: 'org1' (required) | `""`                                                    |
| `client.server.host`                | Hostname of the gRPC data sharing server, example: 'sink.telicent.io' (required)                                                                                                                   | `""`                                                    |
| `client.server.port`                | Port of the gRPC data sharing server (required)                                                                                                                                                    | `443`                                                   |
