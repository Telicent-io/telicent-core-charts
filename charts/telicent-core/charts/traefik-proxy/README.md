...
[Traefik](https://github.com/traefik/traefik) is an open source reverse proxy and ingress controller that makes deploying services and APIs easy.

## Introduction

This chart bootstraps Traefik deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
### Traefik Proxy Exposure Parameters

| Name                               | Description                                                                                                                                              | Value                                            |
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| `service.port`                     | Traefik Proxy service port                                                                                                                               | `8080`                                           |
| `service.type`                     | Traefik Proxy service type                                                                                                                               | `ClusterIP`                                      |
...
| Name                    | Description                                                                                                                                                | Value |
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| `hosts.auth`            | Auth host value, If not set a host is generated using service:'auth',port:'9000' and Release namespace & name.                                             | `""`  |
