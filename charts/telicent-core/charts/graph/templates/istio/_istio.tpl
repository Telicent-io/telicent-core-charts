...
*/}}
{{- define "graph.calServiceAccount" -}}
{{- $envVal := index . 0 -}}
...
{{- else }}
{{- printf "- cluster.local/ns/%s/sa/%s" .Release.Namespace (include "graph.calServiceAccount" (list . .Values.istio.ingress.serviceAccountName) ) }}
{{- end }}
{{- end }}
...
{{- else }}
{{- printf "- cluster.local/ns/%s/sa/%s" .Release.Namespace (include "graph.calServiceAccount" (list . .Values.istio.paperbackWriter.serviceAccountName) ) }}
{{- end }}
{{- end }}
{{- end }}
