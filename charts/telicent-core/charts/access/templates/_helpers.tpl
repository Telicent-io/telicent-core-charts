...
{{- .Values.istio.smartCacheSearch.principal | default (printf "cluster.local/ns/%s/sa/%s-%s" .Release.Namespace .Release.Name .Values.istio.smartCacheSearch.serviceAccountName) | quote }}
{{- end }}
