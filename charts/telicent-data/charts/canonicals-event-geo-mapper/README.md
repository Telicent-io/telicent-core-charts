# Canonicals Event Geo Mapper

A Kafka-based component that operates as part of the Telicent Data parent chart, designed to map and process canonical event data with geospatial context for enhanced location-based analysis and understanding.

## Overview

This chart deploys the Canonicals Event Geo Mapper, which processes canonical event data from Kafka topics and transforms it into geospatially-enriched representations within the Telicent data ecosystem. The mapper adds geographical context and spatial relationships to event data.
...
```bash
helm install canonicals-event-geo-mapper .
```
...
| Name        | Description                                            | Value |
| ----------- | ------------------------------------------------------ | ----- |
| `resources` | Resources for *Canonicals Event Geo Mapper* containers | `{}`  |
