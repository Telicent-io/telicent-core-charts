...
```bash
helm install canonicals-event-validation-mapper .
```
...
| `image.repository`  | Container image name                                                     | `telicent/telicent-canonicals-event-validation-mapper` |
...
| Name        | Description                                                   | Value |
| ----------- | ------------------------------------------------------------- | ----- |
| `resources` | Resources for *Canonicals Event Validation Mapper* containers | `{}`  |
