# ACLED Participants Mapper

A Kafka-based component that operates as part of the Telicent Data parent chart, designed to map and process ACLED (Armed Conflict Location & Event Data) participant information for enhanced actor analysis and understanding.

## Overview

This chart deploys the ACLED Participants Mapper, which processes ACLED participant data from Kafka topics and transforms it into structured actor representations within the Telicent data ecosystem. The mapper enriches participant data with enhanced contextual information and relationships between conflict actors.
...
```bash
helm install acled-participants-mapper .
```
...
| `image.repository`  | Container image name                                                     | `telicent/telicent-acled-pipeline-mapper-event-participants` |
...
| Name        | Description                                          | Value |
| ----------- | ---------------------------------------------------- | ----- |
| `resources` | Resources for *ACLED Participants Mapper* containers | `{}`  |
