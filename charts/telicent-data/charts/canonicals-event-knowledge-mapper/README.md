# Canonicals Event Knowledge Mapper

A Kafka-based component that operates as part of the Telicent Data parent chart, designed to map and process canonical event data into knowledge graph structures for enhanced data understanding and analysis.

## Overview

This chart deploys the Canonicals Event Knowledge Mapper, which processes canonical event data from Kafka topics and transforms it into structured knowledge representations within the Telicent data ecosystem. The mapper enriches raw event data with semantic context and relationships.
...
```bash
helm install canonicals-event-knowledge-mapper .
```
...
| `image.repository`  | Container image name                                                     | `telicent/telicent-canonicals-event-knowledge-mapper` |
...
| Name        | Description                                                  | Value |
| ----------- | ------------------------------------------------------------ | ----- |
| `resources` | Resources for *Canonicals Event Knowledge Mapper* containers | `{}`  |
...
```bash
helm install producer-acled-ontology .
```
