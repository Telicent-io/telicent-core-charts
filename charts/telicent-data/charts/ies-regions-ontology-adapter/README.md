# IES Regions Ontology Adapter

A Kafka-based component that operates as part of the Telicent Data parent chart, designed to adapt and process IES (Information Exchange Standard) regions ontology data for enhanced geographical semantic analysis.

## Overview

This chart deploys the IES Regions Ontology Adapter, which processes IES regions ontology data from Kafka topics and adapts it for compatibility with other systems within the Telicent data ecosystem. The adapter enriches regional data with semantic context and standardized geographical representations.
...
```bash
helm install ies-regions-ontology-adapter .
```
...
| `image.repository`  | Container image name                                                     | `telicent/tc-ies-regions-ontology-adapter` |
