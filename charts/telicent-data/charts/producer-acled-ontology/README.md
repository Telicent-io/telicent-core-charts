# Producer ACLED Ontology

A Kafka producer component that operates as part of the Telicent Data parent chart, specifically designed to publish ACLED (Armed Conflict Location & Event Data) ontology data to Kafka topics.

## Overview

This chart deploys a Kafka producer that processes and publishes ACLED ontology data to configured Kafka topics within the Telicent data ecosystem.
...
| `image.repository`  | Container image name                                                     | `telicent/telicent-acled-pipeline-ontology-adapter` |
...
| `configuration.sourceName`      | Name of the ontology source                       | `ontology-styles-generator` |
