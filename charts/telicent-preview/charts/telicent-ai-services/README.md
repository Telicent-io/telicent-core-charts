# Telicent Package for Telicent AI Services

**Telicent AI Services** provides AI model serving capabilities.

## Introduction

This chart bootstraps Telicent AI Services deployment on a [Kubernetes](https://kubernetes.io) cluster using
...
```console
helm install my-release ./charts/telicent-preview/charts/telicent-ai-services
```
...
.dev/readme-generator-for-helm --config=charts/telicent-core/readme.config \
 --values=charts/telicent-preview/charts/telicent-ai-services/values.yaml \
 --readme=charts/telicent-preview/charts/telicent-ai-services/README.md \
 --schema=charts/telicent-preview/charts/telicent-ai-services/values.schema.json
```
...
Contains Java configuration parameters to be used by the *Telicent AI Services* application
...
Contains configuration parameters specific to the *Telicent AI Services* application

| Name                             | Description                                                              | Value |
| -------------------------------- | ------------------------------------------------------------------------ | ----- |
| `configMap.existingEnvConfigMap` | Name of existing configmap containing *Telicent AI Services* Environment Configuration | `""`  |
...
| Name                   | Description                                                   | Value |
| ---------------------- | ------------------------------------------------------------- | ----- |
| `replicas`             | Number of *Telicent AI Services* replicas to deploy                         | `1`   |
| `revisionHistoryLimit` | Number of controller revisions to keep                        | `5`   |
| `annotations`          | Add extra annotations to the deployment object                | `{}`  |
| `podLabels`            | Add extra labels to the *Telicent AI Services* pod                          | `{}`  |
| `podAnnotations`       | Add extra annotations to the *Telicent AI Services* pod                     | `{}`  |
| `extraEnvVars`         | Array with extra environment variables to add to *Telicent AI Services* pod | `[]`  |
| `extraVolumes`         | Additional containers to be added to the *Telicent AI Services* pod         | `[]`  |
...
| Name                | Description                                                             | Value                        |
| ------------------- | ----------------------------------------------------------------------- | ---------------------------- |
| `image.registry`    | *Telicent AI Services* image registry                                                 | `quay.io`                    |
| `image.repository`  | *Telicent AI Services* image name                                                     | `telicent/telicent-ai-services` |
| `image.tag`         | *Telicent AI Services* image tag. If not set, a tag is generated using the appVersion | `""`                         |
| `image.pullPolicy`  | *Telicent AI Services* image pull policy                                              | `IfNotPresent`               |
...
| Name        | Description                       | Value |
| ----------- | --------------------------------- | ----- |
| `resources` | Resources for *Telicent AI Services* containers | `{}`  |
...
| Name           | Description                                                               | Value       |
| -------------- | ------------------------------------------------------------------------- | ----------- |
| `service.name` | *Telicent AI Services* service name. If not set, a name is generated using the fullname | `""`        |
| `service.port` | *Telicent AI Services* service port                                                     | `8080`      |
| `service.type` | *Telicent AI Services* service port                                                     | `ClusterIP` |
...
*Telicent AI Services* interacts directly with other Telicent Applications using their default service/serviceAccount and port.
