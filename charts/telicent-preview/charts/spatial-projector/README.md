# Telicent Package for Spatial Projector

**Spatial Projector** provides auth capabilities and exposes endpoints for querying user authentication.

## Introduction

This chart bootstraps Spatial Projector deployment on a [Kubernetes](https://kubernetes.io) cluster using
...
| `image.repository`  | Auth server image name                                                     | `098669589541.dkr.ecr.eu-west-2.amazonaws.com/telicent-smart-cache-spatial-projector` |
