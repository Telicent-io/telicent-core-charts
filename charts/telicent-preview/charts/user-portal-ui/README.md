...
| Name        | Description                               | Value |
| ----------- | ----------------------------------------- | ----- |
| `resources` | Resources for *User Portal UI* containers | `{}`  |
...
| Name           | Description                                                                       | Value       |
| -------------- | --------------------------------------------------------------------------------- | ----------- |
| `service.name` | *User Portal UI* service name. If not set, a name is generated using the fullname | `""`        |
| `service.port` | *User Portal UI* service port                                                     | `8080`      |
| `service.type` | *User Portal UI* service type                                                     | `ClusterIP` |
