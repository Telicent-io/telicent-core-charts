...
Telicent AI Sparql Builder is a starter application for querying data in Telicent CORE.
...
| `global.enabled`                 | enabled Enable *AI Sparql Builder* deployment                                                                                                        | `false` |
...
| Name                | Description                                                                       | Value                                |
| ------------------- | --------------------------------------------------------------------------------- | ------------------------------------ |
| `image.registry`    | *AI Sparql Builder* image registry                                                 | `quay.io`                            |
| `image.repository`  | *AI Sparql Builder* image name                                                     | `telicent/telicent-ai-sparql-builder` |
